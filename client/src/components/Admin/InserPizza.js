    ...
    return (
        <>
            <div className={classes.root}>
                ...
                />
                <TextField className={classes.input} name="price" type="number" id="outlined-basic" label="Pris" variant="outlined"
                    onChange={(e) => {
                        setPizzaPrice(e.target.value)
                    }}
                />
                <TextField className={classes.input} name="prisF" type="number" id="outlined-basic" label="Pris Familj" variant="outlined"
                    onChange={(e) => {
                        setPizzaPriceF(e.target.value)
                    }}
                />
                <TextField className={classes.input} name="Ingredients" type="text" id="outlined-basic" label="Ingredients" variant="outlined"
                    onChange={(e) => {
