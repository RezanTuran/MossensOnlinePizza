...
function Order() {
  ...
  const deleteOrder = (pizza) => {
    Axios.delete(
      `https://mossenspizzeria.herokuapp.com/api/deleteOrder/${pizza}`
    );
        ...
        {orderList.map((val) => {
          return (
            <div className="card">
              ...
              <Divider />
              <h4>
                Address: <span className="customerInfo">{val.adress}</span>
              </h4>
              <Divider />
              <h4>
                Postnummer:{' '}
                <span className="customerInfo">{val.postNumber}</span>
              </h4>
              <Divider />
              <h4>
                Telefonnummer: <span className="customerInfo">{val.phone}</span>
              </h4>
              <Divider />
              <h4>
                E-post: <span className="customerInfo">{val.epost}</span>
              </h4>
              <Divider />
              <h4>
                Datum: <span className="customerInfo">{val.date}</span>
              </h4>
              <Divider />
              ...
              <p>
                Antal pizza:{' '}
                <span className="customerInfo">{val.quantity}</span>
              </p>
              <Divider />
              <p>
                Ingredienser:{' '}
              ...
              <p>
                Totalpris:{' '}
                <span className="customerInfo">{val.pizzaPrice} :-</span>
              </p>
              <Divider />
              <Button
                variant="contained"
